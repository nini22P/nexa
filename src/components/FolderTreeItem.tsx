...
export default function FolderTreeItem({
    ...
    const { expandedFolderIds, toggleFolderExpanded, setSidebarOpen } = useBookmarkStore()
    ...
    return (
        <div className="select-none">
            ...
            >
                ...
                <i className={`material-symbols-outlined text-lg ${isActive ? 'text-slate-900' : 'text-slate-400 group-hover:text-slate-600'}`}>
